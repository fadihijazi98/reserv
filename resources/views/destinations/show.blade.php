    ...
    <div class="container">
        ...
        <div class="row justify-content-center p-4">
            ...
            <div class="col-12">
                ...
                @if (session('message'))
                    <div
                        class="text-right alert alert-dark bg-gray-800 text-white alert-dismissible fade show tracking-widest"
                        role="alert">
                        <b>
            ...
            <div class="col-12 p-4 my-2 rounded-lg border-2 border-gray-400">
                ...
                <a href="#">
                    <h1 class="text-2xl text-gray-600 text-right hover:text-gray-500">
                ...
                <div class="container mx-auto">
                    ...
                    <div class="grid lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-1">
                        @foreach(\App\Trip::all()->where('id_destination', $destination->id) as $trip)

                            <div class="relative bg-gray-400 mx-2 my-4 rounded-l-lg rounded-t">
                                    ...
                                    <div class="text-center px-2 py-4">
                                        ...
                                        @if(auth()->guest())
                                            <button
                                                ...
                                                <a href="{{ $trip->getAvailablePassenger() == 0 ? '#' : route('login') }}"
